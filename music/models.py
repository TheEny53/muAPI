...
class Artist(models.Model):
    ...
    founding_year = models.IntegerField(
        null=True, blank=True, validators=YEAR_VALIDATORS)
    ...
    rating = models.CharField(
        max_length=1, choices=RATING, blank=False, null=False)
...
class Album(models.Model):
    ...
    artist = models.ForeignKey(
        to=Artist, on_delete=models.CASCADE, blank=False, null=True)
    ...
    rating = models.CharField(
        max_length=1, choices=RATING, null=False, blank=False)
...
class Song(models.Model):
    ...
    name = models.CharField(max_length=255, null=False, blank=False)
    artist = models.ForeignKey(
        to=Artist, on_delete=models.CASCADE, blank=False)
